...
export default function QuranBitImpactPage() {
  ...
  const handleDonation = (lessons: number, duration: string) => {
    setShowConfirmation(`You've just enabled ${lessons} Quran lessons ${duration} 🎉`)
    setTimeout(() => setShowConfirmation(""), 3000)
  }

  const customPrice = customLessons ? Number.parseInt(customLessons) * 4 : 0
  ...
  const recentActivity = [
    "Aisha enabled 7 lessons (1 week)",
    "Zayd enabled 30 lessons (1 month)",
    "Anonymous just enabled 15 lessons",
    "Maryam enabled 7 lessons (1 week)",
    "Hassan enabled 60 lessons (2 months)",
  ]
  ...
  return (
    <div className="min-h-screen bg-refreshing bg-pattern-dots relative overflow-hidden">
      ...
      <section className="px-6 py-24 md:py-32 text-center max-w-6xl mx-auto relative z-10">
        <div className="animate-slide-up">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed font-light">
            Every $4 enables 1 Quran lesson per month for someone seeking sacred knowledge.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-24 relative z-10">
        <Card className="max-w-lg mx-auto p-8 shadow-elegant border-0 bg-card/95 backdrop-blur-sm animate-scale-in">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-serif font-light text-foreground mb-2">Enable Quran Lessons</h2>
      ...
      <section className="px-6 py-24 bg-secondary/20 backdrop-blur-sm relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif font-light text-foreground mb-4">Our Collective Impact</h2>
            <p className="text-xl text-muted-foreground">Building a global community of knowledge</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <div>
                <div className="text-6xl md:text-7xl font-serif font-light number-highlight mb-2 number-glow">
                  10,000
                </div>
                <div className="text-lg text-muted-foreground font-medium">lessons enabled</div>
              </div>
            </div>
            <div className="space-y-6 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              ...
              <div>
                ...
                <div className="text-lg text-muted-foreground font-medium">enablers worldwide</div>
              </div>
            </div>
            <div className="space-y-6 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              ...
              <div>
                <div className="text-6xl md:text-7xl font-serif font-light number-highlight mb-2 number-glow">8+</div>
                <div className="text-lg text-muted-foreground font-medium">countries impacted</div>
              </div>
            </div>
          </div>
        </div>
                ...
                {leaderboard.map((enabler, index) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <div className="font-semibold text-foreground text-lg">{enabler.lessons} lessons</div>
      ...
      <section className="px-6 py-24 gradient-primary text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-primary-foreground/80 mb-12 max-w-2xl mx-auto">
            Enable Quran lessons today and join thousands making knowledge accessible worldwide.
          </p>
          <Button
